...
| `data/` | Raw files exactly as downloaded. See `data/README.md`|
...
4. Rebase every series to January 2024 = 100 so they are comparable.
5. Cross-check my deflated figures against BEA's published real PCE (Table 2.4.6)

## How to run this 
Open `analysis-inflation-24-26.ipynb` and Restart Kernal and Run all Cells. 
...
## Data as of 
August 15, 2026 - see `data/README.md` for per-file pull dates. 
